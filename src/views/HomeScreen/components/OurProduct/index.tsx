...
const OurProduct = () => {
  return (
    <div className="mt-10 flex flex-col justify-center items-center gap-5 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto max-h-[350px]">
        {products.map((product, index) => (
          <ProductItemVertical key={index} product={product} isBorderImage={true} />
        ))}
      </div>
